...
final class WEVPointsControllerNode: ViewControllerTracingNode {
    ...
    private func initView(navigationBarHeight: CGFloat) {
        ...
        let codeBgView: UIView = {
            ...
            let descLabel = UILabel.lj.configure(font: LJFont.medium(16), textColor: UIColor(red: 0, green: 122/255, blue: 1, alpha: 1), text: "Invite your friends and earn up to 3000 points.")
            descLabel.lj.setLineSpacing()
            descLabel.textAlignment = .center
            descLabel.numberOfLines = 0
