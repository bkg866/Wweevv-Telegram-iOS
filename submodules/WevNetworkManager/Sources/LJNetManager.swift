...
public struct LJNetManager {
    
    public typealias RequestCompletion = (_ result: LJNetManager.Result) -> ()
    ...
    /// 请求头上的基本信息
    public static func baseInfoString() -> String {
    ...
    /// 处理请求结果
    public static func handleNetResponseJSON(response: DataResponse<Any>, _ completion: RequestCompletion) -> () {
...
//                        value["message"] = ""
    ...
    /// code异常处理
    static public func checkError(_ errorData: Result.ApiData) -> Bool {
...
extension LJNetManager {
    ...
    /// url拼接
    public static func appendUrl(api: String) -> URL {
    ...
    /// 随机字符串
    public static var oneceStr: String {
        get {
