...
extension LJExtension where Base == UILabel {
    ...
    @discardableResult
    public func configure(font: UIFont? = nil,
    ...
    public static func configure(font: UIFont = LJFont.regular(14),
    ...
    public static func configure(fontSize: CGFloat = 14,
                          textColor: UIColor = LJColor.black,
                          text: String? = nil) -> Base {
    ...
    ///   - text: 文本
    ///   - lineSpacing: 行间距
    public func setLineSpacingText(_ text: String, lineSpacing: CGFloat = 5) {
        base.text = text
    ...
    public func setLineSpacing(_ lineSpacing: CGFloat = 5) {
