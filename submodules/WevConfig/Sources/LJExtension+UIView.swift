...
extension LJExtension where Base: UIView {
    ...
    /// 添加阴影
    public func addShadow(opacity: Float = 1,
                   radius: CGFloat = 5,
...
//        }
    ...
    public func addBgViewShadow() {
        base.lj.addShadow(opacity: 1, radius: 18, offset: .init(width: 0, height: 6), color: LJColor.hex(0xDEE2E5, 0.32))
    }
    
    /// 切任意圆角
    public func clipsTopCornerRadius(roundedRect rect: CGRect? = nil, byRoundingCorners corners: UIRectCorner, cornerRadii: CGSize) {
